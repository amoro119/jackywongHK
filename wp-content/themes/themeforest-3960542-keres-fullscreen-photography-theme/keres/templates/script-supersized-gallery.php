...
jQuery(function($){
    	$.supersized({
    		...
    		<?php						
    			...
    			$pp_portfolio_random_order = get_option('pp_portfolio_random_order');
    			
    			if(empty($pp_portfolio_random_order))
    			{
    				$pp_portfolio_random_order = 0;
    			}
    		?>
    		//Functionality
    		...
    		random					: 	<?php echo $pp_portfolio_random_order; ?>,		//Randomize slide order (Ignores start slide)
