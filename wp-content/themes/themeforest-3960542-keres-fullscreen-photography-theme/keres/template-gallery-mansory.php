...
<div id="page_content_wrapper">
    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
	    	...
	    	<div id="page_main_content" class="sidebar_content full_width" style="padding-bottom:0">
	    		<?php
    	...
    	<?php
    		...
    		foreach($all_photo_arr as $key => $photo)
    		{
    			...
    			if(!empty($photo->guid))
    			{
    			    ...
    			    $medium_image_url = wp_get_attachment_image_src($photo->ID, 'gallery_4_2', true);
    			}
